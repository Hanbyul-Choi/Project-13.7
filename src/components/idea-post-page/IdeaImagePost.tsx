      ...
      <div className="flex flex-col w-full ml-[20px]">
        ...
        {typeof previewImg === 'string' ? (
          ...
          <div {...getRootProps()} className="hidden sm:block">
            ...
            <div className="rounded-lg font-normal text-base border border-opacityblack h-20 items-center justify-center text-[#bdbdbd] leading-[150%] w-full flex">챌린지 인증하는 사진 예시를 업로드 하세요.</div>
          </div>
        )}
      </div>
    </div>
