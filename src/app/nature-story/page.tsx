...
export default function NaturePage({ searchParams }: { searchParams: { category: string | undefined } }) {
  return (
    <>
      <div
        className={`w-full sm:h-[400px] h-[600px] bg-[#white] sm:bg-[url('/nature-banner.png')] bg-[url('/nature-banner-mo.png')] bg-no-repeat bg-center border-t-2 border-t-black/.5 mb-6`}
      />
      <Layout>
